...
@section('title')
    <title>Sisnoc | Cadastrar Link</title>
@endsection
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  type="text" value="{{old('link_identification')}}" onkeyup="this.value = this.value.toUpperCase()" id="link_identification" name="link_identification"  class="form-control {{ ($errors->has('link_identification') ? 'is-invalid': '') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  type="text" onkeyup="this.value = this.value.toUpperCase()" placeholder="Ex.: 1MB, 10GB ..." value="{{old('bandwidth')}}" id="bandwidth" name="bandwidth" class="form-control {{ ($errors->has('bandwidth') ? 'is-invalid': '') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  type="text" placeholder="Formato IP v.4" value="{{old('monitoring_ip')}}" id="monitoring_ip" name="monitoring_ip" class="form-control {{ ($errors->has('monitoring_ip') ? 'is-invalid': '') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  type="text" value="{{old('serial_router')}}" id="serial_router" name="serial_router" class="form-control {{ ($errors->has('serial_router') ? 'is-invalid': '') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  type="text" placeholder="Formato IP v.4" value="{{old('local_ip_router')}}" id="local_ip_router" name="local_ip_router" class="form-control {{ ($errors->has('local_ip_router') ? 'is-invalid': '') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select style="width: 75%"  name="establishment_id" id="establishment_id" class="form-control multiple-select {{ ($errors->has('establishment_id') ? 'is-invalid': '') }}">
                                                ...
                                                @foreach ($establishments as $establishment)
                                                    <option value="{{$establishment->id}}" {{(old('establishment_id') == $establishment->id ? 'selected' : '')}} >{{$establishment->establishment_code}}</option>
                                                @endforeach
                                            </select>
