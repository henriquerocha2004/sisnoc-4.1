                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong>Editar </strong>  Categoria de Problemas
                            <small style="color:red" class="text-right"><i>*</i> Campos Obrigatórios</small>
                        </div>
                        <div class="card-body card-block">
                            <form action="{{route('category-problem.update', $category->id)}}" method="post" class="" autocomplete="off">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  type="description_category" id="description_category" name="description_category" value="{{old('description_category') ?? $category->description_category}}" class="form-control {{ ($errors->has('description_category') ? 'is-invalid': '') }}"">
