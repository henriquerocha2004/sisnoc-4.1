...
@section('title')
    <title>Sisnoc | Cadastro de Loja</title>
@endsection
                ...
                <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong>Cadastro </strong> de Estabelecimento
                                <small style="color:red" class="text-right"><i>*</i> Campos Obrigatórios</small>
                            </div>
                            <div class="card-body card-block">
                                <form action="{{route('estabilishment.store')}}" method="post" class="" autocomplete="off">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select  name="establishment_status" id="status" class="form-control {{ ($errors->has('establishment_status') ? 'is-invalid': '') }}"">
                                                    ...
                                                    <option value="open" {{(old('establishment_status') == 'open' ? 'selected' : '')}}>Aberto</option>
                                                    <option value="close" {{(old('establishment_status') == 'close' ? 'selected' : '')}}>Fechado</option>
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="opening_hours" value="{{old('opening_hours')}}" name="opening_hours"  class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="address" class=" form-control-label">Endereço<i style="color:red">*</i></label>
                                                <input  type="text" value="{{old('address')}}" id="address" name="address" class="form-control {{ ($errors->has('address') ? 'is-invalid': '') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input  type="text" value="{{old('neighborhood')}}" id="neighborhood" name="neighborhood"  class="form-control {{ ($errors->has('neighborhood') ? 'is-invalid': '') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input  type="text" value="{{old('city')}}" id="city" name="city"  class="form-control {{ ($errors->has('city') ? 'is-invalid': '') }}">
                                                @if($errors->has('city'))
                                                    @component('compoments.feedbackInputs', ['typeFeed' => 'invalid'])
                                                        {{$errors->first('city')}}
                                                    @endcomponent
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input  type="text" value="{{old('state')}}" id="state" name="state" maxlength="2" onkeyup="this.value = this.value.toUpperCase()" placeholder="Sigla, Ex: SP,RJ,BA" class="form-control {{ ($errors->has('state') ? 'is-invalid': '') }}">
                                                @if($errors->has('state'))
                                                    @component('compoments.feedbackInputs', ['typeFeed' => 'invalid'])
                                                        {{$errors->first('state')}}
                                                    @endcomponent
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{old('document_establishment')}}" id="document_establishment" name="document_establishment" placeholder="xx.xxx.xxx/xxxx-xx" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{old('document_establishment_alternate')}}" id="document_establishment_alternate" name="document_establishment_alternate"  class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{old('phone_establishment')}}" id="phone_establishment" name="phone_establishment" placeholder="(xx) xxxx-xxxx"  class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input  type="text" value="{{old('manager_name')}}" id="manager_name" name="manager_name"  class="form-control {{ ($errors->has('manager_name') ? 'is-invalid': '') }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input  type="text" value="{{old('manager_contact')}}" placeholder="(xx) xxxxx-xxxx" id="manager_contact" name="manager_contact"  class="form-control {{ ($errors->has('manager_contact') ? 'is-invalid': '') }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" value="{{old('branch_establishment')}}" id="branch_establishment" name="branch_establishment"  class="form-control phone">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select  name="regional_manager_code" id="regional_manager_code" class="form-control {{ ($errors->has('regional_manager_code') ? 'is-invalid': '') }}">
                                                    ...
                                                    @foreach ($regionalManagers as $regionalManager)
                                                        <option value="{{$regionalManager->id}}" {{(old('regional_manager_code') == $regionalManager->id ? 'selected' : '')}}>{{$regionalManager->name}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select  name="technician_code" id="technician_code" class="form-control {{ ($errors->has('technician_code') ? 'is-invalid': '') }}">
                                                    ...
                                                    @foreach ($technicalManagers as $technicalManager)
                                                        <option value="{{$technicalManager->id}}" {{(old('technician_code') == $technicalManager->id ? 'selected' : '')}} >{{$technicalManager->name}}</option>
                                                    @endforeach
                                                </select>
