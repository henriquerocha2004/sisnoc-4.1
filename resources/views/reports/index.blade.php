                                ...
                                <div class="col-md-4">
                                 ...
                                 <div class="col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('reports.links') }}" method="POST">
                                                @csrf
                                                <button class="btn btn-primary btn-sm pull-right" href="{{ route('reports.links') }}">Gerar</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
