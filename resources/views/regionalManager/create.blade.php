...
@section('title')
    <title>Sisnoc | Cadastrar Gerente Regional</title>
@endsection
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong>Cadastro </strong> de Gerente Regional
                            <small style="color:red" class="text-right"><i>*</i> Campos Obrigatórios</small>
                        </div>
                        <div class="card-body card-block">
                            <form action="{{route('regionalManager.store')}}" method="post" class="" autocomplete="off">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input  type="text" value="{{old('contact')}}" placeholder="(xx) xxxxx-xxxx" id="contact" name="contact"  class="form-control {{ ($errors->has('contact') ? 'is-invalid': '') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  type="email" value="{{old('email')}}" id="email" name="email" class="form-control {{ ($errors->has('email') ? 'is-invalid': '') }}">
                                            @if($errors->has('email'))
                                                @component('compoments.feedbackInputs', ['typeFeed' => 'invalid'])
                                                    {{$errors->first('email')}}
                                                @endcomponent
                                ...
                                <div class="row">
                                    <div class="col-md-12 mt-4">
                                        ...
                                        <input type="hidden" name="selected_establishment" value="{{old('selected_establishment')}}">
                                        <div class="row">
                                            <div class="col col-md-9 mt-2">
                                                <select name="establishment_code[]" id="establishment_code" multiple="" class="form-control {{ ($errors->has('selected_establishment') ? 'is-invalid': '') }}">
                                                    @foreach ($establishments as $establishment)
                                                        @if (old('establishment_code'))
                                                            @foreach (old('establishment_code') as $code)
                                                                @php
