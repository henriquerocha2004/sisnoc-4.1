...
@section('title')
    <title>Sisnoc | Lista e Técnicos </title>
@endsection
    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
                <div class="row">
                        <div class="col-md-12">
                            <!-- DATA TABLE -->
                            <h3 class="title-5 m-b-35">Responsáveis Técnicos</h3>
                            @if (session('alert'))
                            ...
                            <div class="table-data__tool">
                                <div class="table-data__tool-right">
                                    <a href="{{route('technicalManager.create')}}" class="au-btn au-btn-icon au-btn--green au-btn--small">
    ...
    <script>
        $(function(){
            $('.table-data2').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{!! url('table-technical-manager')!!}",
                    columns: [
                        {data: 'name', name: 'name'},
